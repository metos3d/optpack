...
'''.format(model_name))
    ...
    print("Copying job template ...             {0}/template.job.sh".format(model_name))
    os.system("cp optpack/template/template.job.sh {0}/.".format(model_name))

    print("Copying start template ...           {0}/template.start.py".format(model_name))
